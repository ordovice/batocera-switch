...
class YuzuGenerator(Generator):
    ...
    def generate(self, system, rom, playersControllers, gameResolution):
        ...
        #yuzuControllers.generateControllerConfig(system, playersControllers, rom)

        commandArray = ["/usr/wine/lutris/bin/wine64", "/userdata/system/switch/yuzu/yuzu.exe", "z:" + rom]
        return Command.Command(
            array=commandArray,
            env={
                "WINEPREFIX": batoceraFiles.SAVES + "/yuzu",
                "vblank_mode": "0",
                "mesa_glthread": "true",
