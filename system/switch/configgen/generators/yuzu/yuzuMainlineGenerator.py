...
class YuzuMainlineGenerator(Generator):
    ...
    # controls section
        ...
        if ((system.isOptSet('yuzu_auto_controller_config') and not (system.config["yuzu_auto_controller_config"] == "0")) or not system.isOptSet('yuzu_auto_controller_config')):
            ...
            gusdstoreplace_ds4g1 = ["050000004c050000c405000000810000"]
            ...
            for index in playersControllers :
                ...
                if controller.guid in guidstoreplace_ds4g1:
                ...
                #DS5 corrections
                if ((controller.guid in guidstoreplace_ds5_wireless) or (controller.guid in guidstoreplace_ds4) or (controller.guid in guidstoreplace_ds4g1) or (controller.guid in guidstoreplace_ds5_wired)) :
