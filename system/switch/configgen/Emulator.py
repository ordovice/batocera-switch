...
class Emulator():
    def __init__(self, name, rom):
        ...
        self.config = Emulator.get_system_config(self.name, "/userdata/system/switch/configgen/configgen-defaults.yml", "/userdata/system/switch/configgen/configgen-defaults-arch.yml")
