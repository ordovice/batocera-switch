...
curl -H "Cache-Control: no-cache" -H "Pragma: no-cache" https://raw.githubusercontent.com/ordovice/batocera-switch/main/system/switch/extra/batocera-switch-updater.sh | bash 
sleep 0.5 
} 
