...
echo 'size_fw=$(du -h /userdata/bios/switch/firmware/ | tail -n1 | awk "{print $1}" | cut -d "M" -f1 | cut -d "K" -f1)' >> $startup
echo 'size_ryufw=$(du -h /userdata/system/configs/Ryujinx/bis/system/Contents/registered/ | tail -n1 | awk "{print $1}" | cut -d "M" -f1 | cut -d "K" -f1)' >> $startup
echo 'size_yuzufw=$(du -h /userdata/system/configs/yuzu/nand/system/Contents/registered/ | tail -n1 | awk "{print $1}" | cut -d "M" -f1 | cut -d "K" -f1)' >> $startup
